...
class Test(unittest.TestCase):
    ...
    def test(self):
        activate_modules(['sale_w_tax', 'sale_discount'])
        ...
        sale_line.discount_rate = Decimal('1')
        self.assertEqual(sale_line.unit_price, Decimal('0.00'))
        self.assertEqual(sale_line.unit_price, Decimal('0.00'))
        sale.save()
        self.assertEqual(sale_line.amount_w_tax, Decimal('0.00'))
        sale_line.discount_rate = Decimal('0.12')
        self.assertEqual(sale_line.unit_price, Decimal('8.8000'))
        self.assertEqual(sale_line.unit_price_w_tax, Decimal('8.8000'))
